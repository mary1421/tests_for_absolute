...
@pytest.mark.parametrize(
    ...
    [
        ("100 000", "Иванов Иван Иванович", '12.04.1999', '5004 678901', '12.05.2016',
        'г Москва, ул Академика Королева, влд 2А ', '9034567788', 'mail7531@gmail.com', 'p'),
        ("500 000", "", '05.10.1990', '5004 678901', '12.05.2016',
        ...
        ("100 000", "Иванов Иван Иванович", '12.04.1999', '', '12.05.2016',
        'г Москва, ул Академика Королева, влд 2А ', '9034567788', 'mail7531@gmail.com', 'n'),
        ("500 000", "Иванов Иван Иванович", '12.04.1999', '5004 678901', '',
        'г Москва, ул Академика Королева, влд 2А ', '9034567788', 'mail7531@gmail.com', 'n'),
        ...
        ("500 000", "Иванов Иван Иванович", '12.04.1999', '5004 678901', '12.05.2016',
        'г Москва, ул Академика Королева, влд 2А ', '9034567788', '', 'n'),
        ("", "", '12.04.1999', '', '12.05.2016',
        '', '9034567788', '', 'n'),
        ("100 000", "Иванов Иван Иванович", '', '5004 678901', '',
        'г Москва, ул Академика Королева, влд 2А ', '', 'mail7531@gmail.com', 'n')
    ]
)
class TestCalcPolis():
    def test_calc_polis(self, browser, strah_sum, client_fio, client_birth, client_p_n, client_p_d, client_addr, \
        ...
        with allure.step("Проверим, что сумма госпитализации и стоимость полиса рассчитаны верно"):
            allure.attach(browser.get_screenshot_as_png(), name="Форма предвариетльного расчета", attachment_type=AttachmentType.PNG)
        ...
        with allure.step("Вводим необходимые данные"):
            ...
            allure.attach(browser.get_screenshot_as_png(), name="Страница ввода данных", attachment_type=AttachmentType.PNG)
        with allure.step("Переходим в кабинет оплаты"):
            page.go_to_pay()
        time.sleep(20)
        allure.attach(browser.get_screenshot_as_png(), name="Страница оплаты", attachment_type=AttachmentType.PNG)
        if test_flag == 'p':
