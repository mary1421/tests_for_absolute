...
class BasePage:
    ...
    def should_be_payment_url(self):
        ...
        assert "securepayments.tinkoff" in current_url, (
            "Подстрока securepayments.tinkoff не найдена в url"
    ...
    def should_empty_message(self, par):
        EMPTY_MES = [
            ...
            "Не указаны серия/номер паспорта.",
            "Не указаны дата выдачи паспорта.",
            "Не указан адрес регистрации.",
